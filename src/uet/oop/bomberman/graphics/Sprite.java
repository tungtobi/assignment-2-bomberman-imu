...
public class Sprite {
	...
	|--------------------------------------------------------------------------
	 */
	public static Sprite player_up = new Sprite(16, 4, 0, SpriteSheet.player, 12, 15);
	public static Sprite player_down = new Sprite(16, 2, 0, SpriteSheet.player, 13, 16);
	public static Sprite player_left = new Sprite(16, 0, 0, SpriteSheet.player, 14, 16);
	public static Sprite player_right = new Sprite(16, 7, 0, SpriteSheet.player, 14, 16);
	
	public static Sprite player_up_1 = new Sprite(16, 5, 0, SpriteSheet.player, 12, 15);
	public static Sprite player_up_2 = player_up; //new Sprite(16, 0, 2, SpriteSheet.player, 12, 15);
	
	public static Sprite player_down_1 = new Sprite(16, 3, 0, SpriteSheet.player, 13, 16);
	public static Sprite player_down_2 = player_down; //new Sprite(16, 2, 2, SpriteSheet.player, 12, 16);
	
	public static Sprite player_left_1 = new Sprite(16, 1, 0, SpriteSheet.player, 13, 15);
	public static Sprite player_left_2 = player_left; //new Sprite(16, 3, 2, SpriteSheet.player, 12 ,16);
	
	public static Sprite player_right_1 = new Sprite(16, 6, 0, SpriteSheet.player, 13, 15);
	public static Sprite player_right_2 = player_right; //new Sprite(16, 1, 2, SpriteSheet.player, 12, 16);
